...
const productSchema = z.object({
    ...
    calification: z.number().min(0, { message: "La calificación debe ser un número positivo" }).max(10, { message: "La calificación debe ser un número entre 0 y 10" }), // Calificación entre 0 y 10
...
const productSchemaPatch = z.object({
    ...
    calification: z.number().min(0, { message: "La calificación debe ser un número positivo" }).max(10, { message: "La calificación debe ser un número entre 0 y 10" }).optional(), 
